...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/keyframe-animation.css') ?>">
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/animated-text.min.css') ?>">
...
<body>
            ...
            <div class="navigation-wrapper">
                <div class="navigation-inner">
                    ...
                    <div class="header-right">
                        <!-- <a class='default-btn d-none d-md-block' href='contact.html'>Start Free Trial</a> -->
    ...
    <div id="sidebar-area" class="sidebar-area">
        ...
        <div class="sidebar-content">
            <div class="site-logo">
                <a href='index.html'><img src="<?= base_url('assets/img/logo-dark.png') ?>" alt="logo"></a>
            </div>
            <p>9621 Agnes Crossing, Lake Suzanneview, New Mexico Island 84604-9295.</p>
            <ul class="sidebar-info">
                <li><span>Call:</span> 5267-214-392</li>
                <li><span>Email:</span> <a href="https://te.dynamiclayers.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f3ba9d959cddbf969297959f9c84b39e929a9fdd909c9e">[email&#160;protected]</a></li>
            </ul>
