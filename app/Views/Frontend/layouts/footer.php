    ...
    <footer class="footer-section">
        <div class="container">
                ...
                <div class="col-lg-3 col-sm-6 sm-padding">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-list">
                            ...
                            <li><a href="#"><span class="__cf_email__" data-cfemail="edbe828b998a8883ad88958c809d8188c38e8280">[email&#160;protected]</span></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 sm-padding">
            ...
            <div class="copyright-text">
                © <span id="currentYear"></span> Softgen, All Rights Reserved. Design By <a href="https://themeforest.net/user/themeeaster/portfolio" target="_blank">ThemeEaster</a>
            </div>
        </div>
    </footer>
    <!--/.footer-section-->
    ...
    <!--jQuery Lib-->
    <script data-cfasync="false" src="<?= base_url('cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js')?>"></script><script src="<?= base_url('assets/js/vendor/jquary-3.6.0.min.js')?>"></script>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'96b549a53b7adb88',t:'MTc1NDU1NDEyMy4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='<?= base_url('cdn-cgi/challenge-platform/h/b/scripts/jsd/8359bcf47b68/maind41d.js')?>';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
